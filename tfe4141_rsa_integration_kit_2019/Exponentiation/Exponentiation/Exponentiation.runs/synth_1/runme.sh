...
HD_PWD='C:/Users/hnd00/OneDrive/Github/TFE4141/tfe4141_rsa_integration_kit_2019/Exponentiation/Exponentiation/Exponentiation.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Exponentiation.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Exponentiation.tcl
